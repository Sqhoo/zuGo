			...
			<div class="properties-section">
				...
				<div class="properties-grids">
					...
					<li style="margin-top:10px"><input id="testFile"  type="file" multiple name="file"></li>
								...
								<div class="clearfix"></div>
							<div><input type="button" id="submit"value="修改房源" class="btn btn-info col-xs-2" style="margin-right:20px" onclick="update()"><input type="button" value="删除房源" class="btn btn-info col-xs-2" onclick="deleteHouse()"></div>
							</form>
						</div>
						</div>	
					<div class="clearfix"></div>

							...
							<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
								...
								<div id="myTabContent" class="tab-content">
                                            ...
                                            <div class="forsale-grids">
                                                ...
                                                <div class="forsale1">
                                                    <div class="forsale-left">
                                                        <img src="/zugo/housepic/${housemap.value[0].pic_path}" class="img-responsive" alt="/">
                                                    </div>
                                                    <div class="forsale-right">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/front/token?houseId=${housemap.key.house_id}"class="button4">more details</a>
                                                    </div>
									...
									<%--<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                                        <%
											PageBean houses= (PageBean) request.getAttribute("pb");
                                        %>
                                        <%
                                            for (int i=0;i<houses.getHouses().size();i=i+3){
                                                int x=0;
                                               if (houses.getHouses().size()-i<3){
                                                   x=houses.getHouses().size()-i;
                                               }else {
                                                   x=3;
                                               }
                                        %>
                                            <div class="forsale-grids1">
                                                ...
                                                %>
                                                    <div class="col-md-4 forsale-grid1">
                                                        ...
                                                        <h5><%=houses.getHouses().get(j).getHouse_name()%></h5>
                                                        <p><%=houses.getHouses().get(j).getHouse_desc()%><a href="#">Know More</a></p>
                                                        <h6>￥ <%=houses.getHouses().get(j).getHouse_rent()%> </h6>
                                                    </div>
                                                <%}%>
                                                <div class="clearfix"></div>
                                            </div>
						...
						<div class="feature">
							...
							<c:forEach items="${randHouse}" var="randhouse">
								<div class="feature-top">
									<img src="/zugo/housepic/${randhouse.value[0].pic_path}" class="img-responsive" alt="/">
									<h5>${randhouse.key.house_name}</h5>
									<p>这座房子位于 ${randhouse.key.house_province} ${randhouse.key.house_city} ${randhouse.key.house_detailaddr},${randhouse.key.house_desc}
										<a href="${pageContext.request.contextPath}/front/token?houseId=${randhouse.key.house_id}">Know More</a></p>
								</div>
							</c:forEach>
						</div>
					</div>

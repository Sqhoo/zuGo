				 	...
				 	<c:forEach varStatus="status" var="uwh" items="${userWithHouse}">
						<div class="agent-grids">
							<div class="col-md-6 agent-grid " style="margin-top:15px">
								...
								<a href="${pageContext.request.contextPath }/front/houseList?method=showOther&user_id=${uwh.user_id}" class="button3 hvr-shutter-out-horizontal" style="height:30px;padding:4px">know more</a>
								</div>

					...
					<div class="blog-grids">
						<div class="col-md-9 blog-grid">
							...
							<div class="blog">
								...
								<a href="single.jsp"><img src="images/b2.jpg" class="img-responsive" alt=""/></a>
								<p>Tart donut gummi bears unerdwear.com tootsie roll chocolate bar gummi bears bear claw. Apple pie tart chocolate cake jelly beans. Unerdwear.com drag̩e sweet muffin icing macaroon. Jelly marzipan toffee cotton candy sweet roll. Jelly croissant jujubes carrot cake marshmallow donut biscuit wafer marzipan. Muffin pastry jujubes donut pastry chocolate bar cake candy chocolate. Dessert donut</p>
								<a href="single.jsp" class="button5 hvr-shutter-out-horizontal">Read More</a>
							</div>
						</div>
						<div class="col-md-3 blog-grid1">
							...
							<div class="tags">
								<h4>Tags</h4>
								<ul>
									<li><a href="single.jsp">Lorem</a></li>
									<li><a href="single.jsp">consectetur</a></li>
									<li><a href="single.jsp">dolore</a></li>
									<li><a href="single.jsp">aliqua</a></li>
									<li><a href="single.jsp">sit amet</a></li>
									<li><a href="single.jsp">ipsum</a></li>
									<li><a href="single.jsp">Lorem</a></li>
									<li><a href="single.jsp">consectetur</a></li>
									<li><a href="single.jsp">dolore</a></li>
									<li><a href="single.jsp">aliqua</a></li>

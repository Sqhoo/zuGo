                    ...
                    <div class="offer-grid1" id="randhouse">
                        ...
                        <div class="offer1">
                            <div class="offer-left">
                                <a href="single.jsp" class="mask"><img src="/zugo/housepic/${house.value[0].pic_path}"
                                                                       class="img-responsive zoom-img" alt=""/></a>
                            </div>
                            <div class="offer-right">
                                <h5><label>￥</label> ${house.key.house_rent} Per Month - <span>${house.key.house_area}m<sup>2</sup></span></h5>
                                <p>这座房子位于 ${house.key.house_province} ${house.key.house_city} ${house.key.house_detailaddr},${house.key.house_desc}</p>
                                <a href="${pageContext.request.contextPath}/front/token?houseId=${house.key.house_id}" class="button1">more details</a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>

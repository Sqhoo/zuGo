...
public class HouseDaoImpl implements HouseDao {
    ...
    public List<HouseWithPic> findHouseWithPic(String userid) throws SQLException {
        return  runner.query("select h.*,pic.pic_path from house h,house_pic pic  where h.house_id=pic.house_id and user_id=? group by house_id", new BeanListHandler<HouseWithPic>(HouseWithPic.class),userid);
    }
